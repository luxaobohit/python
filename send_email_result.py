...
class SendResultEmail(object):
    ...
    def send_result(self):
        ...
        port = 25
        from_addr = 'luxiaobohit@163.com'
        password = 'luxiaobo891224'
        to_addr = ['luxiaobohit@foxmail.com',] # better to read from external file

        email_content = self.__read_output_content()
        email_header = self.__read_output_subject()

        msg = MIMEText(email_content, 'plain', 'utf-8')
        msg['From'] = 'luxiaobohit@163.com'
        msg['To'] = 'luxiaobohit@foxmail.com'
...
if __name__ == '__main__':
    sre = SendResultEmail('output.xml')
    #sre.load_output_xml()
    sre.send_result()
